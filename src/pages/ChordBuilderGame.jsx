            ...
            <section>
                <div className="card" style={{ maxWidth: 500, margin: '0 auto', textAlign: 'center' }}>
                    ...
                    <div style={{ margin: 'var(--space-lg) 0' }}>
                        <h4>Final Score</h4>
                        <p style={{ fontSize: '2rem', fontWeight: 'bold', color: 'var(--color-primary)' }}>{gameSummary?.score}</p>
                        {highScore !== null && (
                            <p className="muted">
                    ...
                    <p className="small muted">
                        You earned {gameSummary ? gameSummary.score : 0} XP and {gameSummary ? Math.floor(gameSummary.score / 100) : 0} Tokens!
                    </p>
